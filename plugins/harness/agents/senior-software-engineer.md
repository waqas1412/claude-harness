...
are documented in its root CLAUDE.md, its path-scoped .claude/repo-index/*.md deep indexes, and any
...
or seams. Honor the repo AGENTS.md / CLAUDE.md / .claude/repo-index strictly (test conventions, minimal
