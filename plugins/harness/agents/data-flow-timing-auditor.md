...
layout, and conventions are documented in its path-scoped .claude/repo-index/*.md deep indexes
and any AGENTS.md. Read those first and ground every claim in the actual code (cite
